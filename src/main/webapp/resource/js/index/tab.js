...
layui.define(["jquery", "element", "nprogress"], function (i) {
    var t = layui.jquery, e = layui.element, a = t(document), l = t(window), n = function () {
        this.config = {elem: void 0, mainUrl: "/admin/index/first.html"}, this.v = "1.0.2"
    };
    ...
    var c = {
        ...
        createTabDom: function () {
            ...
            if (i._parentElem = e.elem, !i.tabDomExists()) {
                ...
                t('.refresh').click(function() {
                    var n = t('.layui-show').children("iframe");
        ...
        tabAdd: function (i) {
            var t = this, a = t._config, l = (i = i || {
                    id: (new Date).getTime(),
                    title: "新标签页",
                    icon: "fa-file",
                    url: "404.html"
                }).title, n = i.icon, c = i.url, s = i.id;
