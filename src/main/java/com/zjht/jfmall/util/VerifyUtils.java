...
public class VerifyUtils {
	...
	/*
	 * 验证是否为移动手机号码 regex.mobile.phone.number
	 */
	public static boolean isMobilePhoneNumber(String mobile){
		if(StringUtils.isEmpty(mobile)){
			return false;
		}
		String regex = PropertyUtil.getPropertyValue("regex","regex.mobile.phone.number").trim();
		Pattern p = Pattern.compile(regex);
		Matcher m = p.matcher(mobile);
	...
	public static boolean isNumber(String number){
		...
		String regex = PropertyUtil.getPropertyValue("regex","regex.number").trim();
		Pattern p = Pattern.compile(regex);
     ...
     * @param IDStr  
     *            身份证号  
     * @return 有效：返回"" 无效：返回String错误信息提示  
     * @throws ParseException
     * @author huangshipiao
     * @time   2015-9-8 下午3:59:58     
     */
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String IDCardNum = "441624298906020852";
        
        System.out.println(IDCardValidate(IDCardNum));
        // System.out.println(cc.isDate("1996-02-29"));  
        System.out.println(isPlateNumber("粤P52585"));
    }  
    /*********************************** 身份证验证结束 ****************************************/  
	/**
	 * 判断是否为车牌号码
	 * @author huangshipiao
	 * @time   2015-9-8 下午3:58:24 
	 * @param plateNumber
	 * @return
	 */
    public static boolean isPlateNumber(String plateNumber){
    	Pattern pattern = Pattern.compile("^[\u4e00-\u9fa5]{1}[A-Z0-9]{6}$");
