...
@Controller
public class AppFileUploadAct {

    private static final Logger log = LoggerFactory.getLogger(AppFileUploadAct.class);
    ...
    @NoNeedAuth
    @ResponseBody
    @RequestMapping(value = "/file/deleteFile", method = {RequestMethod.GET, RequestMethod.POST})
